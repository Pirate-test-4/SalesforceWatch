...
//  SalesforceWatch
// 
// AppleWatch currently doesnt support animations. Let's make a little
// wrapper to create a chevron-based ring graphic
//
...
class Chevron {
    ...
    class func getChevronImage(num: Int) -> NSString {
        ...
        println("Chevron providing image name "+imageName)
        return imageName
    }
}